                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="/owner/data_supplier/supplier" method="GET">
                                        <div class="row">
                                            <div class="col-4">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    <div class="btn-group">
                                                        @if($d->status_supplier == 0)
                                                        <a href="#" class="validasi_supplier btn btn-info btn-sm" id="{{ $d->id_supplier }}" >
                                                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-edit"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" /><path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z" /><path d="M16 5l3 3" /></svg>
                                                            Validasi
                                                        </a>
                                                        @else
                                                        <form action="/owner/data_supplier/supplier/{{ $d->id_supplier }}/batalkan_validasi_supplier" style="margin-left: 5px;" method="POST">
                                                            @csrf    
                                                            <a class="btn btn-danger btn-sm batalkan_validasi_supplier" >
                                                        ...
                                                        <form action="/owner/data_supplier/supplier/{{ $d->id_supplier }}/delete_supplier" style="margin-left: 5px;" method="POST">
                                                            @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/owner/data_supplier/supplier/store_supplier" method="POST" id="frmInfrmsSpplr" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
<div class="modal modal-blur fade" id="modal-valdiasisupplier" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Validasi Data Supplier</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" id="loadvalidasiformsupplier">
...
<script>
    $(function(){
        ...
        $(".validasi_supplier").click(function(){
            var id = $(this).attr('id');
            $.ajax({
                type:'POST',
                url:'/owner/data_supplier/supplier/validasi_supplier',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
                ...
                success:function(respond){
                    $("#loadvalidasiformsupplier").html(respond);
                }
            });
            $("#modal-valdiasisupplier").modal("show");
        });


        $(".batalkan_validasi_supplier").click(function(e){
        ...
        //    $.ajax({
        //        type:'POST',
        //        url:'/owner/data_supplier/supplier/edit_supplier',
        //        cache:false,
        //        data:{
        //            _token : "{{ csrf_token() }}",
        //            id : id
