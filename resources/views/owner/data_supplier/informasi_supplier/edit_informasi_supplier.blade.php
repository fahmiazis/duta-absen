<form action="/owner/data_supplier/informasi_supplier/{{ $data->id_informasi_supplier }}/update_informasi_supplier" method="POST" id="frmdata" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="number" value="{{ $data->total_harga_informasi_supplier}}" id="total_harga_informasi_supplier" class="form-control" name="total_harga_informasi_supplier" placeholder="Total Harga">
            </div>
        </div>
    </div>
    <div class="row mb-3">
