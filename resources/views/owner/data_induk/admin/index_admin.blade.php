            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/owner/data_induk/admin" method="GET">
                                    <div class="row">
                                        <div class="col-3">
                            ...
                            <div class="col-12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($admin as $d)
                                        @php
                                            $path = Storage::url('uploads/data_induk/admin/'.$d->foto_admin);
                                        @endphp
                                        <tr>
                                            ...
                                            <td>{{ $d->no_hp_admin }}</td>
                                            <td>
                                                @if (empty($d->foto_admin))
                                                <img src="{{ asset('assets/img/nophoto.jpg') }}" class="avatar" alt="">
                                                @else
                                                <img src="{{ url($path) }}" class="avatar" alt="">
                                                @endif
                                            </td>
                                            <td>{{ $d->kecamatan_admin }}</td>
                                            <td>{{ $d->password_admin }}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="#" class="edit_admin btn btn-info btn-sm" id="{{ $d->id_admin }}" >
                                                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-edit"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" /><path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z" /><path d="M16 5l3 3" /></svg>
                                                    </a>
                                                    <form action="/owner/data_induk/admin/{{ $d->id_admin }}/delete_admin" style="margin-left: 5px;" method="POST">
                                                        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/owner/data_induk/admin/store_admin" method="POST" id="frmAdmn" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="nama_admin" class="form-control" name="nama_admin" placeholder="Masukkan Nama Lengkap">
                              </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="email_admin" class="form-control" name="email_admin" placeholder="Masukkan E-Mail">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="alamat_admin" class="form-control" name="alamat_admin" placeholder="Masukkan Alamat">
                              </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon">
                                ...
                                <input type="text" value="" id="no_hp_admin" class="form-control" name="no_hp_admin" placeholder="Masukkan Nomor HP">
                              </div>
                        </div>
                    </div>
