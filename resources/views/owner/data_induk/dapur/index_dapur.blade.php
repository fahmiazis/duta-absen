            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/owner/data_induk/dapur" method="GET">
                                    <div class="row">
                                        <div class="col-4">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <form action="/owner/data_induk/dapur/{{ $d->id_dapur }}/delete_dapur" style="margin-left: 5px;" method="POST">
                                                        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/owner/data_induk/dapur/store_dapur" method="POST" id="frmDpr" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
