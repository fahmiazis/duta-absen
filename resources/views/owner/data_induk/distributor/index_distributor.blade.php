                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align:right">
                                <a href="#" class="btn btn-primary" id="btnTambahDistributor">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/owner/data_induk/distributor" method="GET">
                                    <div class="row">
                                        <div class="col-3">
                            ...
                            <div class="col-12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                        <tr>
                                            <td>{{ $loop->iteration + $distributor->firstItem()-1 }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <form action="/owner/data_induk/distributor/{{ $d->id_distributor }}/delete_distributor" style="margin-left: 5px;" method="POST">
                                                        @csrf
                        ...
                        {{ $distributor->links('vendor.pagination.bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
...
{{-- Modal Input Data Distributor --}}
<div class="modal modal-blur fade" id="modal-inputdistributor" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data Distributor</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="/owner/data_induk/distributor/store_distributor" method="POST" id="frmDstrbtr" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="nama_distributor" class="form-control" name="nama_distributor" placeholder="Nama Lengkap">
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="email_distributor" class="form-control" name="email_distributor" placeholder="E-Mail">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="alamat_distributor" class="form-control" name="alamat_distributor" placeholder="Alamat">
                              </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon">
                                ...
                                <input type="text" value="" id="no_hp_distributor" class="form-control" name="no_hp_distributor" placeholder="Nomor HP">
                              </div>
                        </div>
                    </div>
                    <div class="row mt-3 mb-3">
                        <div class="col-6">
                            <input type="file" id="foto_distributor" name="foto_distributor" class="form-control">
                        </div>
...
<div class="modal modal-blur fade" id="modal-editdistributor" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body" id="loadeditformdistributor">
...
<script>
    $(function(){
        $("#btnTambahDistributor").click(function(){
            $("#modal-inputdistributor").modal("show");
        });
        ...
        $(".edit_distributor").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/owner/data_induk/distributor/edit_distributor',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
                ...
                success:function(respond){
                    $("#loadeditformdistributor").html(respond);
                }
            });
            $("#modal-editdistributor").modal("show");
        });

        $(".delete-confirm-distributor").click(function(e){
        ...
        $("#frmDstrbtr").submit(function(){
            var nama_lengkap = $("#nama_lengkap").val();
            var email = $("#email").val();
            var alamat = $("#alamat").val();
            var no_hp = $("#no_hp").val();
            var foto = $("#frmDstrbtr").find("#foto").val();
