...
@section('content')
<form action="/owner/data_koperasi/{{ $data->id_data_koperasi }}/update_modal_keluar_data_koperasi" method="POST" id="frmmodalmasukdatakoperasi" enctype="multipart/form-data">
    @csrf
