<form action="{{ url('/poin/'.$murid->nisn.'/updatepoin/'.$riwayat_pelanggaran->id_riwayat) }}" method="POST" id="frmMurid" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $riwayat_pelanggaran->pelanggaran ?? '' }}" id="pelanggaran" class="form-control" name="pelanggaran" placeholder="Input Pelanggaran">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $riwayat_pelanggaran->poin ?? '' }}" id="poin" class="form-control" name="poin" placeholder="Masukkan Poin">
            </div>
        </div>
    </div>
