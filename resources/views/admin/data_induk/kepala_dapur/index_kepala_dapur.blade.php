    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/admin/data_induk/kepala_dapur/store_kepala_dapur" method="POST" id="frmKplDpr" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
<script>
    $(function(){
        ...
        $(".edit_kepala_dapur").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/admin/data_induk/kepala_dapur/edit_kepala_dapur',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
