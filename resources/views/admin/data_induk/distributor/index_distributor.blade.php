            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/admin/data_induk/distributor" method="GET">
                                    <div class="row">
                                        <div class="col-6">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/admin/data_induk/distributor/store_distributor" method="POST" id="frmDstrbtr" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
<script>
    $(function(){
        ...
        $(".edit_distributor").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/admin/data_induk/distributor/edit_distributor',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
