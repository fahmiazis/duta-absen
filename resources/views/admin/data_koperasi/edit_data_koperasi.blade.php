...
@section('content')
<form action="/owner/data_koperasi/{{ $data->id_data_koperasi }}/update_data_koperasi" method="POST" id="frmdatakoperasi" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="number" value="{{ $data->modal_masuk }}" id="modal_masuk" class="form-control" name="modal_masuk" placeholder="Masukkan Modal Masuk">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="number" value="{{ $data->modal_keluar }}" id="modal_keluar" class="form-control" name="modal_keluar" placeholder="Masukkan Modal Keluar">
            </div>
        </div>
    </div>
    <div class="row">
