...
@section('content')
<form action="/admin/data_koperasi/{{ $data->id_data_koperasi }}/update_modal_masuk_data_koperasi" method="POST" id="frmmodalmasukdatakoperasi" enctype="multipart/form-data">
    @csrf
