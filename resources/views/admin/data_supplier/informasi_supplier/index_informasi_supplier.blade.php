            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/admin/data_supplier/informasi_supplier" method="GET">
                                    <div class="row">
                                        <div class="col-10">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                <div class="btn-group">
                                                    ...
                                                    <form action="/admin/data_supplier/informasi_supplier/{{ $d->id_informasi_supplier }}/delete_informasi_supplier" style="margin-left: 5px;" method="POST">
                                                        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/admin/data_supplier/informasi_supplier/store_informasi_supplier" method="POST" id="frmSpplr" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
<script>
    $(function(){
        ...
        $(".edit_informasi_supplier").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/admin/data_supplier/informasi_supplier/edit_informasi_supplier',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
        ...
        $(".tambah_barang_supplier").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/admin/data_supplier/informasi_supplier/tambah_barang_supplier',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
        ...
        $(".lihat_barang_supplier").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/admin/data_supplier/informasi_supplier/lihat_barang_supplier',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
        ...
        $(".nota_informasi_supplier").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/admin/data_supplier/informasi_supplier/nota_informasi_supplier',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
        ...
        $(".bukti_terima_informasi_supplier").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/admin/data_supplier/informasi_supplier/bukti_terima_informasi_supplier',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
