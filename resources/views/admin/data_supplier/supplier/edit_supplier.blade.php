    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $data->nama_supplier }}" id="nama_supplier" class="form-control" name="nama_supplier" placeholder="Nama Supplier">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $data->alamat_supplier }}" id="alamat_supplier" class="form-control" name="alamat_supplier" placeholder="Alamat">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $data->no_hp_supplier }}" id="no_hp_supplier" class="form-control" name="no_hp_supplier" placeholder="No. HP">
            </div>
        </div>
    </div>
    <div class="row">
