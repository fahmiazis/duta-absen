    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-5">
            ...
            <div class="section mb-5">
                ...
                @endif
                <form action="/proseslogindistributor" method="POST">
                    @csrf
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <input type="text" name="email_distributor" class="form-control" id="email_distributor" placeholder="Masukkan E-Mail Anda" style="opacity: 0.5;">
                            <i class="clear-input">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <input type="password" class="form-control" id="password_distributor" name="password_distributor" placeholder="Masukkan Password Anda" style="opacity: 0.5;">
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                        </div>
