  ...
  <div class="container-fluid">
    ...
    <h1 class="navbar-brand navbar-brand-autodark">
      <a href="/panel/dashboardadmin">
        <img src="../../assets/img/logo_smkn2.png" alt="SMKN_2_Kalianda" style="width: 120px; height:auto">
      </a>
    </h1>
        ...
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="nav-link" href="/murid" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/jurusan" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="nav-link" href="/presensi/monitoring" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/poin/poin" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="nav-link" href="/presensi/laporan" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/presensi/rekap" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/presensi/rekapsemester" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/presensi/rekaptahun" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="nav-link" href="/konfigurasi/lokasikantor" style="margin-left: 26px;">
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
                ...
                <a class="nav-link" href="/konfigurasi/jamsekolah" style="margin-left: 26px;">
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
