    ...
    <div class="navbar-nav flex-row d-lg-none">
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          <li class="nav-item">
            <a class="nav-link" href="/owner/dashboardowner" >
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="nav-link" href="/owner/data_induk/admin" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/data_induk/kepala_dapur" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/data_induk/distributor" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/data_induk/data_pekerja" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/data_induk/dapur" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="nav-link" href="/owner/data_supplier/supplier" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/data_supplier/informasi_supplier" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-users-group"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 13a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" /><path d="M8 21v-1a2 2 0 0 1 2 -2h4a2 2 0 0 1 2 2v1" /><path d="M15 5a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" /><path d="M17 10h2a2 2 0 0 1 2 2v1" /><path d="M5 5a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" /><path d="M3 13v-1a2 2 0 0 1 2 -2h2" /></svg>
                </span>
                <span class="nav-link-title">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/owner/data_koperasi" >
              <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <!--<li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="nav-link" href="/owner/informasi/menu_harian" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/informasi/stok_limit" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/informasi/pengiriman" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <!--<a class="nav-link" href="/owner/laporan/stok" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/laporan/stok_harian" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/laporan/stok_bulanan" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/laporan/distribusi" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/laporan/keuangan" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/laporan/harian_dapur" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
        ...
        <a class = "btn btn-danger"href="/proseslogoutowner" onclick="showSuccess()" style="margin-left: 10px; margin-bottom: 20px;" >Log out</a>
      </div>
    </div>
  </aside>