            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/kepala_dapur/menu_harian" method="GET">
                                    <div class="row">
                                        <div class="col-md-4">
                                ...
                                <table class="table table-bordered">
                                    <thead class="table-light">
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align: center; width:20%">Bahan</th>
                                            <th style="text-align: center; width:20%">Kendala</th>
...
<script>
    $(function(){
        ...
        $(".tambah_bahan_terpakai").click(function(){
            var id = $(this).attr('data-id');
            $.ajax({
                type:'POST',
                url:'/kepala_dapur/menu_harian/tambah_bahan_terpakai',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
                ...
                success:function(respond){
                    $("#loadformtambahbahanterpakai").html(respond);
                }
            });
            $("#modal-tambahbahanterpakai").modal("show");
        });
        ...
        $(".lihat_bahan_terpakai").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/kepala_dapur/menu_harian/lihat_bahan_terpakai',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
        ...
        $(".tambah_kendala").click(function(){
            var id = $(this).attr('data-id');
            $.ajax({
                type:'POST',
                url:'/kepala_dapur/menu_harian/tambah_kendala',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
                ...
                success:function(respond){
                    $("#loadformtambahkendala").html(respond);
                }
            });
            $("#modal-tambahkendala").modal("show");
        });
        ...
        $(".lihat_kendala").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/kepala_dapur/menu_harian/lihat_kendala',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
