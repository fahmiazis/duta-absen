            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/kepala_dapur/stok_keluar" method="GET">
                                    <div class="row">
                                        <div class="col-md-4">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/kepala_dapur/stok_keluar/store_stok_keluar" method="POST" id="frmStkMsk" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="tanggal_keluar" name="tanggal_keluar" class="form-control" placeholder="Masukkan Tanggal" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="number" value="" id="jumlah_keluar" class="form-control" name="jumlah_keluar" placeholder="Masukkan Jumlah Stok Keluar">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <textarea id="keterangan_stok_keluar" name="keterangan_stok_keluar" class="form-control" rows="1" placeholder="Tuliskan keterangan di sini..."></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
...
<script>
    $(function(){
        ...
        $(".edit_stok_keluar").click(function(){
            var id = $(this).attr('id');
            $.ajax({
                type:'POST',
                url:'/kepala_dapur/stok_keluar/edit_stok_keluar',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
        ...
        $("#frmStkMsk").submit(function(){
            ...
            var tujuan_stok_keluar = $("#tujuan_stok_keluar").val();
            var keterangan_stok_keluar = $("#keterangan_stok_keluar").val();
            ...
            if(tanggal_keluar==""){
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'OK'
                      ...
                      $("#tujuan_stok_keluar").focus();
                  });
                return false;
            } else if (keterangan_stok_keluar==""){
                Swal.fire({
                    title: 'Warning!',
