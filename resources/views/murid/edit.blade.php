<form action="/murid/{{ $murid->nik }}/update" method="POST" id="frmMurid" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" readonly value="{{ $murid->nik }}" id="nik" class="form-control" name="nik" placeholder="NIK">
              </div>
        </div>
    </div>
    <div class="row">
